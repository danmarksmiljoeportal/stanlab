...
namespace Dmp.Stanlab.References.RequisitionApi.Specifications
{
    ...
    public partial class AnalysisOffering 
    {
        ...
        /// <summary>Sample fraction that determines in which fraction the analysis will be performed, e.g. total, filtration concentrate or filtered volume. Stancode list 1026</summary>
